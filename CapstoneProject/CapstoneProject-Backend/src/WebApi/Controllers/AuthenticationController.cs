...
public class AuthenticationController : ApiControllerBase
{
    ...
    private const string REDIRECT_URI = "https://localhost:7245/api/Authentication/GoogleSignIn";
    ...
    public IActionResult GoogleSignInStartAsync()
    {
        ...
        var googleAuthorizationUrl = $"https://accounts.google.com/o/oauth2/v2/auth?" + //soru isareti bir parametre gonderiyorum demek
                                     $"client_id={clientId}&" +
                                     $"response_type=code&" +
    ...
    public async Task<IActionResult> GoogleSignInAsync(string code, CancellationToken cancellationToken)
    {
        ...
        var redirectUrl = $"http://localhost:5174/social-login?{query}"; // http://localhost:5174/
